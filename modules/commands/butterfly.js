const API = "https://api.botcahx.biz.id/api/photooxy/butterfly?TioXd&apikey=d9e9eb44&text="
...
module.exports.run = async function ({ api, event, args,}) {
    ...
    api.sendMessage({body: `💙🍒Ye Lo Meri Jaan✨🧡 `, attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
